...
class MainApplication:
    ...
    def merge_output_results(self):
        ...
        try:
            ...
            # 匹配所有 chunk 格式文件：aaa_chunk_nBBB
            chunk_pattern = re.compile(r'^(.+?)_chunk_(\d+)(.*)\.txt$')
            chunk_files = []
            ...
            if not chunk_files:
                messagebox.showwarning("警告", "未找到符合 chunk 格式的文件！")
                return
            ...
            # 生成唯一的汇总文件
            output_filename = "merged_zong.txt"
